...
# -------- READ DATA ----------
f99 = open('theta_05_square.txt').readlines()
...
# -------- SAVE FINAL RESULT ----------
f1 = open('percolation_threshold_theta_05_square_new.txt', 'w')
...
plt.savefig("theta_fit_square_new.png", dpi=300, bbox_inches='tight')
