...
# -------- OPEN LOG FILE ----------
f_log = open('tri_print_output_new.txt', 'w')

# -------- READ DATA ----------
f99 = open('theta_05_tri.txt').readlines()
...
# -------- SAVE FINAL RESULT ----------
f1 = open('percolation_threshold_theta_05_tri_new.txt', 'w')
...
plt.savefig("theta_fit_tri_new.png", dpi=300, bbox_inches='tight')
