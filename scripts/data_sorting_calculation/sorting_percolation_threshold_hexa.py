## 'hexa_240.txt' --> N=100; Raw data (contains values associated with all ensembles, i.e., before average)
...
f1=open('hexa_240.txt').readlines()
count1=int(len(f1))

f2=open('percolation_threshold_hexa_240.txt', 'w')
...
for i in range(count1):
        ...
        if str(f1[i].split()[0])=='##theta':
                ...
                fraction_of_giant_component_formatted=float("%.1f"%float(f1[i].split()[3]))
...
f2=open('percolation_threshold_hexa_240.txt', 'a')
